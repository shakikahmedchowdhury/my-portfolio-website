        ...
        <header className="bg-red-600">
            <div className="container mx-auto flex justify-between">
                ...
                <div className='inline-flex py-3 px-3 my-6'>
                    ...
                    <SocialIcon url='https://www.linkedin.com/in/shakik-ahmed-chowdhury-859933192/' className="mr-4" target="_blank" fgColor='#fff' style={{ height: 35, width: 35 }} />
